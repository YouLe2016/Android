...
class LoadingView(context: Context, var attrs: AttributeSet?, defStyleAttr: Int) : View(context, attrs, defStyleAttr) {
    ...
    private var scaleStartFraction: Float =
        0.toFloat() //小球一次移动期间，进度在[0,scaleStartFraction]期间根据rtlScale、ltrScale逐渐缩放，取值为[0,0.5]
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        Log.i(
            "LodingView",
            "width = " + wSize + "   height = " + hSize + "   mode = " + (wMode shr 30) + "  " + (hMode shr 30)
        )
